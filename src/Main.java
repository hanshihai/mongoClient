...
public class Main {
	...
	private void update(String collection, String key, String value, String update_key, String original_value,
		...
		if (update_key.indexOf(".") != -1) {
			...
			JSONObject test = function(value_json, part2, original_value, new_value);
    ...
    public  JSONObject function(JSONObject obj, String keyMain, String valueMain, String newValue) throws Exception {
    ...
    public static void printUsage() {
        ...
        System.out.println("10. update collection by key-value:   collection key value update_key original_value new_value update"+
        		            "eg1:ImageIndexJsonDao _id 9511753c79164bbeb5872089f88e4f2c orgId 456 update"+
                            " eg2:ImageIndexJsonDao _id 9511753c79164bbeb5872089f88e4f2c value.jbilling_status CREATE deleted update");
        System.out.println("11. quit:                             q (or quit exit)");
